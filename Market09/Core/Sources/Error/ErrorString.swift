...
public enum ErrorString {
    ...
    public enum Auth {
        ...
        public static let userBanned         = "차단된 계정입니다."
        public static let rateLimited        = "요청이 너무 많습니다. 잠시 후 다시 시도해주세요."
    }

    public enum Storage {
        public static let saveFailed   = "데이터 저장에 실패했습니다."
        public static let loadFailed   = "데이터를 불러올 수 없습니다."
        public static let deleteFailed = "데이터 삭제에 실패했습니다."
        public static let notFound     = "요청한 데이터를 찾을 수 없습니다."
    }
}
